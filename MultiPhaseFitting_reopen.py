...
def fit_reopen(confirmed0, death0, hosp0, n_0, para_init, start_point, metric1, metric2, metric3):
	...
	optimal = minimize(loss2, [uni(gamma_range[0], gamma_range[1]),
	                           uni(gamma2_range[0], gamma2_range[1]),
	                           uni(a1_range[0], a1_range[1]),
	                           uni(a2_range[0], a2_range[1]),
	                           uni(a3_range[0], a3_range[1]),
	                   ...
	                   args=(para_init, confirmed, death, hosp, start_point, n_0, SIRG_new), method='L-BFGS-B',
	                   bounds=[gamma_range,
	                           gamma2_range,
	                           a1_range,
	                           a2_range,
	...
	return [gamma, gamma2, a1, a2, a3, h, Hiding_init, k, k2, metric1, metric2, metric3], min_loss
...
def MT_reopen_dist(state, confirmed_reopen, death_reopen, hosp_reopen, n_0, para_init, start_point, para_reopen):
	...
	[gamma, gamma2, a1, a2, a3, h, Hiding_init, k, k2, metric1, metric2, metric3] = para_reopen
	paras = [para_reopen]  # store the best fit parameters in the first row
	with concurrent.futures.ProcessPoolExecutor() as executor:
		t1 = time.perf_counter()
...
def save_para_reopen(state, paras):
	para_label = ['gamma', 'gamma2', 'a1', 'a2', 'a3', 'h', 'Hiding_init', 'k', 'k2', 'metric1', 'metric2', 'metric3']
